 ...
 */
     ...
     */ 
         ...
         * @see \Osiset\ShopifyApp\Macros\TokenRedirect::__invoke()
         * @static 
         */ 
        public static function tokenRedirect($route, $params = [], $absolute = true)
        {            //Method inherited from \Illuminate\Routing\Redirector         
                        /** @var \Osiset\ShopifyApp\Macros\TokenRedirect $instance */
...
')
     ...
     */ 
         ...
         * @return string 
         * @see \Osiset\ShopifyApp\Macros\TokenRoute::__invoke()
         * @static 
         */ 
        public static function tokenRoute($route, $params = [], $absolute = true)
